...
(defvar dotemacs-themes-base-faces
  '(;; --- custom faces -----------------------
    ...
    (region               :background region     :foreground nil   :distant-foreground (dotemacs-darken fg 0.2) :extend t)
    ...
    ;; ediff
    (ediff-fine-diff-A    :background (dotemacs-blend selection bg 0.7) :weight 'bold :extend t)
    (ediff-fine-diff-B    :inherit 'ediff-fine-diff-A)
    (ediff-fine-diff-C    :inherit 'ediff-fine-diff-A)
    (ediff-current-diff-A :background (dotemacs-blend selection bg 0.3) :extend t)
    ...
    (magit-diff-added             :foreground (dotemacs-darken green 0.2)  :background (dotemacs-blend green bg 0.1) :extend t)
    (magit-diff-added-highlight   :foreground green                    :background (dotemacs-blend green bg 0.2) :weight 'bold :extend t)
    (magit-diff-base              :foreground (dotemacs-darken orange 0.2) :background (dotemacs-blend orange bg 0.1) :extend t)
    (magit-diff-base-highlight    :foreground orange                   :background (dotemacs-blend orange bg 0.2) :weight 'bold :extend t)
    (magit-diff-context           :foreground (dotemacs-darken fg 0.4) :background bg :extend t)
    ...
    (magit-diff-hunk-heading           :foreground bg                    :background (dotemacs-blend violet bg 0.3) :extend t)
    (magit-diff-hunk-heading-highlight :foreground bg                    :background violet :weight 'bold :extend t)
    (magit-diff-removed                :foreground (dotemacs-darken red 0.2) :background (dotemacs-blend red base3 0.1) :extend t)
    (magit-diff-removed-highlight      :foreground red                   :background (dotemacs-blend red base3 0.2) :weight 'bold :extend t)
    ...
    (outline-4 :foreground (dotemacs-lighten blue 0.25)    :weight 'bold :extend t)
    (outline-5 :foreground (dotemacs-lighten magenta 0.25) :weight 'bold :extend t)
    (outline-6 :foreground (dotemacs-lighten blue 0.5)     :weight 'bold :extend t)
    (outline-7 :foreground (dotemacs-lighten magenta 0.5)  :weight 'bold :extend t)
    (outline-8 :foreground (dotemacs-lighten blue 0.8)     :weight 'bold :extend t)
