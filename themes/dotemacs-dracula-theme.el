...
(def-dotemacs-theme dotemacs-dracula
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ((org-block &override) :background (dotemacs-darken base1 0.125) :foreground violet)
   ((org-block-begin-line &override) :background (dotemacs-darken base1 0.125) :foreground comments)
